            ...
            <div className="flex flex-wrap justify-around gap-10">
                ...
                <div className="lg:w-[95%] p-5 shadow-2xl flex flex-col items-center lg:flex-row rounded mt-8 bg-[#2f2f2f39]">
                    ...
                    <div className="flex flex-col text-white">
                        <h2 className="text-[32px] text-semibold mb-3 text-center">Prevenção</h2>
                        <p >Conheça todos os tratamentos odontológicos disponíveis na Sorridents para você cuidar do seu sorriso e da sua saúde bucal!</p>
                    </div>
                </div>
            </div>
        </section>
